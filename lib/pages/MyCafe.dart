...
class _Mycafe  extends State<Mycafe > {
  ...
  Widget build(BuildContext context) {
    ...
    appBar: AppBar(
      title: Text('Cafes creados por $nombre'),
    ),
    body: Center(
      child: BottomBar.mainUsuario.misCafes.isEmpty
          ? const Column(
          ...
          : ListView.builder(
              ...
              itemCount: BottomBar.mainUsuario.misCafes.length,
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                BottomBar.mainUsuario.misCafes[index].nombre,
                                style: const TextStyle(
                                    fontSize: 18, color: Colors.white),
                              ),
                              Text(
                                BottomBar.mainUsuario.misCafes[index]
                                    .descripcion,
                                style: const TextStyle(
                                  ...
                                  TextButton(
                                    ...
                                    onPressed: () {
                                      Navigator.push(
                                        ...
                                        MaterialPageRoute(
                                          builder: (context) =>
                                               InfoCafe( cofee:  BottomBar.mainUsuario.misCafes[index],usuario:  BottomBar.mainUsuario.misCafes[index].miCreador,),
                                        ),
                                      );
                                    },
                                  ),
